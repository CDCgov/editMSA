...
use Getopt::Long;
GetOptions( 	'display-k-tons|D=i'=> \$ktons, 'remove-k-tons|R' => \$removeKtons, 'tab-formatted|T' => \$tabDelimited,
		'show-column-support|S' => \$showSupport, 'a2m-insertions-only|A' => \$a2mInsertionsOnly
		);
